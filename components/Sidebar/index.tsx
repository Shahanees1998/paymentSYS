...
const Sidebar = (): JSX.Element => {
  ...
  return (
    <>
      <aside
        ref={sidebar}
        className={`fixed left-0 top-0 bottom-0 right-0 z-9999 flex w-72.5 flex-col overflow-y-hidden bg-black duration-300 ease-linear dark:bg-boxdark  lg:translate-x-0 ${
